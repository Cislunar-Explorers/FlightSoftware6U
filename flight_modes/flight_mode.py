...
from utils.constants import (  # noqa F401
    ...
    INTERVAL,
    DELAY,
    REG_ADDRESS, REG_VALUE, REG_SIZE,
    DET_ENABLE_UINT8, DET0_BIAS_UINT8, DET1_BIAS_UINT8, DET0_THRESHOLD_UINT8, DET1_THRESHOLD_UINT8, RATE_WIDTH_MIN,
    RATE_WIDTH_MAX, BIN_WIDTH, BIN_0_MIN_WIDTH, RATE_INTERVAL, VETO_THRESHOLD_MIN, VETO_THRESHOLD_MAX, CONFIG_WRITE_PERIOD,
    CONFIG_ROTATE_PERIOD, DATE_WRITE_PERIOD, RATE_DATA_ROTATE_PERIOD, HISTOGRAM_ROTATE_PERIOD,
