...
from fsw.opnav.core.sense import select_camera, record_video
from fsw.utils.constants import OPNAV_MEDIA_DIR
from fsw.opnav.core.const import CameraRecordingParameters
from fsw.opnav.core.opnav import __get_elapsed_time
...
def record_and_extract():
    ...
    frames0 = extract_frames(
        ...
        frameDiff=recordings[0][1],
        endTimestamp=recordings[0][2],
    ...
    frames1 = extract_frames(
        ...
        frameDiff=recordings[1][1],
        endTimestamp=recordings[1][2],
        cameraRecParams=camera_rec_params,
    )
    ...
    frames2 = extract_frames(
        ...
        frameDiff=recordings[2][1],
        endTimestamp=recordings[2][2],
        cameraRecParams=camera_rec_params,
    )
    ...
    frames3 = extract_frames(
        ...
        frameDiff=recordings[3][1],
        endTimestamp=recordings[3][2],
        cameraRecParams=camera_rec_params,
    )
    ...
    frames4 = extract_frames(
        ...
        frameDiff=recordings[4][1],
        endTimestamp=recordings[4][2],
        cameraRecParams=camera_rec_params,
    )
    ...
    frames5 = extract_frames(
        ...
        frameDiff=recordings[5][1],
        endTimestamp=recordings[5][2],
        cameraRecParams=camera_rec_params,
    )
