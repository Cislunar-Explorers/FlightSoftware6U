...
def test_flight_commands():
    ...
    for enum, command_dict in zipped_enums_command_dicts:
        ...
        try:
            ...
            commands_not_in_both = set(all_enum_commands).symmetric_difference(
                all_command_ids
            )
...
def test_flight_codecs():
    ...
    for fm_obj, command_enum in fm_enums_zipped:
        ...
        try:
            commands_not_in_both = set(command_enum_list).symmetric_difference(
                command_codecs_list
            )
