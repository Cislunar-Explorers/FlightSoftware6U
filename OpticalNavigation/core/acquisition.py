...
from OpticalNavigation.core.const import ACQUISITION_ANGLE_INCREMENT, ACQUISITION_COMPENSATION_ROTATION, \
    ACQUISITION_START_ANGLE, ACQUISITION_ANGLE_DISPLACEMENT
