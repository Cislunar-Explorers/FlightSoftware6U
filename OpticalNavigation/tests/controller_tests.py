...
class TestControllerOnEclipseAndCrescentImagesDataset(TestCase):

    def __init__(self, *args, **kwargs):
        super(TestControllerOnEclipseAndCrescentImagesDataset, self).__init__(*args, **kwargs)

    def test_controller_EM1_3DOF_Trajectory_June_27_2020_3600sec(self):
        """
        ...
        moonEph = pd.read_csv(TEST_EM1_3DOF_Trajectory_June_27_2020_3600sec + TEST_EM1_3DOF_Trajectory_June_27_2020_3600sec_moonEph).to_numpy()
        sunEph = pd.read_csv(TEST_EM1_3DOF_Trajectory_June_27_2020_3600sec + TEST_EM1_3DOF_Trajectory_June_27_2020_3600sec_sunEph).to_numpy()
