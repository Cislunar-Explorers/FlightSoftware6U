...
if __name__ == "__main__":
    ...
    print("struct:   " + str(teststruct))
    teststruct.field1 = 25
    print("field1:   " + str(teststruct.field1))
    teststruct.field2 = 255
    print("field2:   " + str(teststruct.field2))
    teststruct.field3 = 257
    print("field3:   " + str(teststruct.field3))
